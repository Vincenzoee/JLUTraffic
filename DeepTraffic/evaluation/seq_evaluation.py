...
def evaluation(city, exp_path, model_name, start_time):
    ...
    test_node_data = pickle.load(
        open(r'H:\bilibili_code\JGRM-main\data\JGRM_DATASET\{}\{}_1101_1115_data_sample10w.pkl'.format(city, city), 'rb')) # data_seq_evaluation.pkl
    ...
    test_seq_data = pickle.load(
        open('../data/JGRM_DATASET/{}/{}_1101_1115_data_seq_evaluation.pkl'.format(city, city),
             'rb'))
    ...
    seq_embedding = get_seq_emb_from_traj_withRouteOnly(seq_model, test_data, batch_size=64)
