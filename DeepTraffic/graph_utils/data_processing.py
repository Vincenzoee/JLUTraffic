...
def compute_time_statistics(sources, destinations, timestamps):
  ...
  for k in range(len(sources)):
    ...
    all_timediffs_src.append(c_timestamp - last_timestamp_sources[source_id])  # 每个节点相对上个时刻的时间差，可平均看节点更新频率
    all_timediffs_dst.append(c_timestamp - last_timestamp_dst[dest_id])
    last_timestamp_sources[source_id] = c_timestamp  # 可以改为各个节点在历史所有时刻的集合
